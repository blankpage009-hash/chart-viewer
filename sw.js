...
const CACHE = 'ncv-v26';  // v26: 공항 즐겨찾기를 사이드바 Airport 리스트로(별 아이콘, 설정 창에서는 삭제),
// 차트 뷰어 제목 앞 ICAO 흰 판 배지, Charts 제목 옆에 공항 하나만 나올 때 이름·국가 표시,
// Airport 리스트 이름·국가 칸 왼쪽 정렬 (2026-08-03)
