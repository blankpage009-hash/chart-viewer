...
function aiPrompt(chart) {
  const byType = {
    ...
    APP: [
      ...
      '고도 제한 | FAF(최종접근픽스) 이름과 고도',
      '결심고도는 차트에 적힌 그대로, 괄호 안 숫자까지 반드시 함께 쓴다.',
      '표기 예시(값은 그대로 베끼지 말고 이 모양만 따를 것): ILS DA(H) 238 ft (200 ft)',
      '접근 방식이 여러 개면 방식마다 줄을 나눈다. 예시 모양: LOC MDA(H) 420 ft (382 ft)',
  ...
  return [
    ...
    '- 차트에 괄호로 딸린 숫자가 있으면 괄호까지 그대로 옮긴다. 앞 숫자만 쓰고 버리지 마라.',
    '  (결심고도의 지표 기준 높이처럼, 괄호 안 숫자가 실제로 필요한 값인 경우가 많다)',
    '',
